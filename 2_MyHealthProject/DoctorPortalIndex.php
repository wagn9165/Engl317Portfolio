...
<body>
  ...
  <div class="home-buttons">
    <a class="w3-button w3-xlarge w3-round w3-blue w3-ripple" href="DoctorPortalDiagnosis.php">Diagnosis</a>
  </div>
  ...
  <!--Charges Button-->
  <div class="home-buttons">
    <a class="w3-button w3-xlarge w3-round w3-blue w3-ripple" href="DoctorPortalCharges.php">Charges</a>
  </div>
